...
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gsttaglist_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstquery_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstelement_h;
...
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstdevice_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gststreamcollection_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gststreams_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstminiobject_h;
with Glib.Error;

package GStreamer.message is
   type GstMessage is private;
   type GstMessageType is new Integer;
