...
package GStreamer.GST_Low_Level.gstreamer_1_0_gst_base_gstqueuearray_h is
  ...
  --  
   ...
   function gst_queue_array_new (initial_size : GLIB.guint) return System.Address;  -- gst/base/gstqueuearray.h:34
   ...
   function gst_queue_array_pop_head (c_array : System.Address) return System.Address;  -- gst/base/gstqueuearray.h:38
   pragma Import (C, gst_queue_array_pop_head, "gst_queue_array_pop_head");

   function gst_queue_array_peek_head (c_array : System.Address) return System.Address;  -- gst/base/gstqueuearray.h:39
   pragma Import (C, gst_queue_array_peek_head, "gst_queue_array_peek_head");

   procedure gst_queue_array_push_tail (c_array : System.Address; data : System.Address);  -- gst/base/gstqueuearray.h:41
   pragma Import (C, gst_queue_array_push_tail, "gst_queue_array_push_tail");

   function gst_queue_array_is_empty (c_array : System.Address) return GLIB.gboolean;  -- gst/base/gstqueuearray.h:44
   pragma Import (C, gst_queue_array_is_empty, "gst_queue_array_is_empty");

   function gst_queue_array_drop_element (c_array : System.Address; idx : GLIB.guint) return System.Address;  -- gst/base/gstqueuearray.h:46
   ...
   function gst_queue_array_find
     (c_array : System.Address;
      ...
      data : System.Address) return GLIB.guint;  -- gst/base/gstqueuearray.h:49
   pragma Import (C, gst_queue_array_find, "gst_queue_array_find");

   function gst_queue_array_get_length (c_array : System.Address) return GLIB.guint;  -- gst/base/gstqueuearray.h:53
   pragma Import (C, gst_queue_array_get_length, "gst_queue_array_get_length");

  -- Functions for use with structures  
   function gst_queue_array_new_for_struct (struct_size : GLIB.gsize; initial_size : GLIB.guint) return System.Address;  -- gst/base/gstqueuearray.h:57
   pragma Import (C, gst_queue_array_new_for_struct, "gst_queue_array_new_for_struct");

   procedure gst_queue_array_push_tail_struct (c_array : System.Address; p_struct : System.Address);  -- gst/base/gstqueuearray.h:60
   pragma Import (C, gst_queue_array_push_tail_struct, "gst_queue_array_push_tail_struct");

   function gst_queue_array_pop_head_struct (c_array : System.Address) return System.Address;  -- gst/base/gstqueuearray.h:63
   pragma Import (C, gst_queue_array_pop_head_struct, "gst_queue_array_pop_head_struct");

   function gst_queue_array_peek_head_struct (c_array : System.Address) return System.Address;  -- gst/base/gstqueuearray.h:65
   pragma Import (C, gst_queue_array_peek_head_struct, "gst_queue_array_peek_head_struct");

   function gst_queue_array_drop_struct
     (c_array : System.Address;
      idx : GLIB.guint;
      p_struct : System.Address) return GLIB.gboolean;  -- gst/base/gstqueuearray.h:67
