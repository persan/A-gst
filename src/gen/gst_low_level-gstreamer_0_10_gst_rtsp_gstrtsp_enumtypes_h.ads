...
package GST_Low_Level.gstreamer_0_10_gst_rtsp_gstrtsp_enumtypes_h is
   ...
   function gst_rtsp_result_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/rtsp/gstrtsp-enumtypes.h:12
   pragma Import (C, gst_rtsp_result_get_type, "gst_rtsp_result_get_type");

   function gst_rtsp_event_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/rtsp/gstrtsp-enumtypes.h:14
   pragma Import (C, gst_rtsp_event_get_type, "gst_rtsp_event_get_type");

   function gst_rtsp_family_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/rtsp/gstrtsp-enumtypes.h:16
   pragma Import (C, gst_rtsp_family_get_type, "gst_rtsp_family_get_type");

   function gst_rtsp_state_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/rtsp/gstrtsp-enumtypes.h:18
   pragma Import (C, gst_rtsp_state_get_type, "gst_rtsp_state_get_type");

   function gst_rtsp_version_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/rtsp/gstrtsp-enumtypes.h:20
   pragma Import (C, gst_rtsp_version_get_type, "gst_rtsp_version_get_type");

   function gst_rtsp_method_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/rtsp/gstrtsp-enumtypes.h:22
   pragma Import (C, gst_rtsp_method_get_type, "gst_rtsp_method_get_type");

   function gst_rtsp_auth_method_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/rtsp/gstrtsp-enumtypes.h:24
   pragma Import (C, gst_rtsp_auth_method_get_type, "gst_rtsp_auth_method_get_type");

   function gst_rtsp_header_field_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/rtsp/gstrtsp-enumtypes.h:26
   pragma Import (C, gst_rtsp_header_field_get_type, "gst_rtsp_header_field_get_type");

   function gst_rtsp_status_code_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/rtsp/gstrtsp-enumtypes.h:28
   pragma Import (C, gst_rtsp_status_code_get_type, "gst_rtsp_status_code_get_type");

end GST_Low_Level.gstreamer_0_10_gst_rtsp_gstrtsp_enumtypes_h;
