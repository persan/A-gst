...
package GStreamer.GST_Low_Level.gstreamer_0_10_gst_gstformat_h is
  ...
  -- query for format details  
   ...
   function gst_format_iterate_definitions return access GStreamer.GST_Low_Level.gstreamer_0_10_gst_gstiterator_h.GstIterator;  -- gst/gstformat.h:109
   pragma Import (C, gst_format_iterate_definitions, "gst_format_iterate_definitions");

end GStreamer.GST_Low_Level.gstreamer_0_10_gst_gstformat_h;
