...
package GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstpoll_h is
  ...
  --  
   ...
   function gst_poll_new (controllable : GLIB.gboolean) return System.Address;  -- gst/gstpoll.h:64
   ...
   function gst_poll_add_fd (set : System.Address; fd : access GstPollFD) return GLIB.gboolean;  -- gst/gstpoll.h:72
   pragma Import (C, gst_poll_add_fd, "gst_poll_add_fd");

   function gst_poll_remove_fd (set : System.Address; fd : access GstPollFD) return GLIB.gboolean;  -- gst/gstpoll.h:73
   pragma Import (C, gst_poll_remove_fd, "gst_poll_remove_fd");

   function gst_poll_fd_ctl_write
     (set : System.Address;
      fd : access GstPollFD;
      active : GLIB.gboolean) return GLIB.gboolean;  -- gst/gstpoll.h:75
   pragma Import (C, gst_poll_fd_ctl_write, "gst_poll_fd_ctl_write");

   function gst_poll_fd_ctl_read
     (set : System.Address;
      fd : access GstPollFD;
      active : GLIB.gboolean) return GLIB.gboolean;  -- gst/gstpoll.h:76
   ...
   function gst_poll_fd_has_closed (set : System.Address; fd : access GstPollFD) return GLIB.gboolean;  -- gst/gstpoll.h:79
   pragma Import (C, gst_poll_fd_has_closed, "gst_poll_fd_has_closed");

   function gst_poll_fd_has_error (set : System.Address; fd : access GstPollFD) return GLIB.gboolean;  -- gst/gstpoll.h:80
   pragma Import (C, gst_poll_fd_has_error, "gst_poll_fd_has_error");

   function gst_poll_fd_can_read (set : System.Address; fd : access GstPollFD) return GLIB.gboolean;  -- gst/gstpoll.h:81
   pragma Import (C, gst_poll_fd_can_read, "gst_poll_fd_can_read");

   function gst_poll_fd_can_write (set : System.Address; fd : access GstPollFD) return GLIB.gboolean;  -- gst/gstpoll.h:82
   pragma Import (C, gst_poll_fd_can_write, "gst_poll_fd_can_write");

   function gst_poll_wait (set : System.Address; timeout : GLIB.guint64) return GLIB.gint;  -- gst/gstpoll.h:84
   pragma Import (C, gst_poll_wait, "gst_poll_wait");

   function gst_poll_set_controllable (set : System.Address; controllable : GLIB.gboolean) return GLIB.gboolean;  -- gst/gstpoll.h:86
   ...
   procedure gst_poll_set_flushing (set : System.Address; flushing : GLIB.gboolean);  -- gst/gstpoll.h:88
   pragma Import (C, gst_poll_set_flushing, "gst_poll_set_flushing");

   function gst_poll_write_control (set : System.Address) return GLIB.gboolean;  -- gst/gstpoll.h:90
   pragma Import (C, gst_poll_write_control, "gst_poll_write_control");

   function gst_poll_read_control (set : System.Address) return GLIB.gboolean;  -- gst/gstpoll.h:91
