...
package GST_Low_Level.gstreamer_0_10_gst_interfaces_photography_enumtypes_h is
   ...
   function gst_photography_noise_reduction_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/interfaces/photography-enumtypes.h:12
   pragma Import (C, gst_photography_noise_reduction_get_type, "gst_photography_noise_reduction_get_type");

   function gst_white_balance_mode_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/interfaces/photography-enumtypes.h:14
   pragma Import (C, gst_white_balance_mode_get_type, "gst_white_balance_mode_get_type");

   function gst_colour_tone_mode_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/interfaces/photography-enumtypes.h:16
   pragma Import (C, gst_colour_tone_mode_get_type, "gst_colour_tone_mode_get_type");

   function gst_scene_mode_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/interfaces/photography-enumtypes.h:18
   pragma Import (C, gst_scene_mode_get_type, "gst_scene_mode_get_type");

   function gst_flash_mode_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/interfaces/photography-enumtypes.h:20
   pragma Import (C, gst_flash_mode_get_type, "gst_flash_mode_get_type");

   function gst_focus_status_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/interfaces/photography-enumtypes.h:22
   pragma Import (C, gst_focus_status_get_type, "gst_focus_status_get_type");

   function gst_photo_caps_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/interfaces/photography-enumtypes.h:24
   pragma Import (C, gst_photo_caps_get_type, "gst_photo_caps_get_type");

   function gst_photo_shake_risk_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/interfaces/photography-enumtypes.h:26
   pragma Import (C, gst_photo_shake_risk_get_type, "gst_photo_shake_risk_get_type");

   function gst_flicker_reduction_mode_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/interfaces/photography-enumtypes.h:28
   pragma Import (C, gst_flicker_reduction_mode_get_type, "gst_flicker_reduction_mode_get_type");

   function gst_focus_mode_get_type return GLIB.GType;  -- /usr/include/gstreamer-0.10/gst/interfaces/photography-enumtypes.h:30
   pragma Import (C, gst_focus_mode_get_type, "gst_focus_mode_get_type");

end GST_Low_Level.gstreamer_0_10_gst_interfaces_photography_enumtypes_h;
