...
package GStreamer.GST_Low_Level.gstreamer_0_10_gst_interfaces_interfaces_enumtypes_h is
  ...
  -- enumerations from "colorbalance.h"  
   function gst_color_balance_type_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:12
   pragma Import (C, gst_color_balance_type_get_type, "gst_color_balance_type_get_type");

  -- enumerations from "mixer.h"  
   function gst_mixer_type_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:16
   pragma Import (C, gst_mixer_type_get_type, "gst_mixer_type_get_type");

   function gst_mixer_message_type_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:18
   pragma Import (C, gst_mixer_message_type_get_type, "gst_mixer_message_type_get_type");

   function gst_mixer_flags_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:20
   pragma Import (C, gst_mixer_flags_get_type, "gst_mixer_flags_get_type");

  -- enumerations from "mixertrack.h"  
   function gst_mixer_track_flags_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:24
   pragma Import (C, gst_mixer_track_flags_get_type, "gst_mixer_track_flags_get_type");

  -- enumerations from "navigation.h"  
   function gst_navigation_command_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:28
   pragma Import (C, gst_navigation_command_get_type, "gst_navigation_command_get_type");

   function gst_navigation_query_type_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:30
   pragma Import (C, gst_navigation_query_type_get_type, "gst_navigation_query_type_get_type");

   function gst_navigation_message_type_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:32
   pragma Import (C, gst_navigation_message_type_get_type, "gst_navigation_message_type_get_type");

   function gst_navigation_event_type_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:34
   pragma Import (C, gst_navigation_event_type_get_type, "gst_navigation_event_type_get_type");

  -- enumerations from "streamvolume.h"  
   function gst_stream_volume_format_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:38
   pragma Import (C, gst_stream_volume_format_get_type, "gst_stream_volume_format_get_type");

  -- enumerations from "tunerchannel.h"  
   function gst_tuner_channel_flags_get_type return GLIB.GType;  -- gst/interfaces/interfaces-enumtypes.h:42
   pragma Import (C, gst_tuner_channel_flags_get_type, "gst_tuner_channel_flags_get_type");

end GStreamer.GST_Low_Level.gstreamer_0_10_gst_interfaces_interfaces_enumtypes_h;
