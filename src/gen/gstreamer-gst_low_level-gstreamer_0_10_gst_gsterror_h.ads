...
package GStreamer.GST_Low_Level.gstreamer_0_10_gst_gsterror_h is
  ...
  --  
   ...
   GST_RESOURCE_ERROR_NUM_ERRORS : constant GstResourceError := 15;  -- gst/gsterror.h:150
  ...
  --  
   ...
   GST_STREAM_ERROR_NUM_ERRORS : constant GstStreamError := 14;  -- gst/gsterror.h:198
  ...
  -- Hide this compatibility type from introspection  
   function gst_g_error_get_type return GLIB.GType;  -- gst/gsterror.h:245
   pragma Import (C, gst_g_error_get_type, "gst_g_error_get_type");

   function gst_error_get_message (domain : Glib.GQuark; code : GLIB.gint) return access GLIB.gchar;  -- gst/gsterror.h:248
   pragma Import (C, gst_error_get_message, "gst_error_get_message");

   function gst_stream_error_quark return Glib.GQuark;  -- gst/gsterror.h:249
   pragma Import (C, gst_stream_error_quark, "gst_stream_error_quark");

   function gst_core_error_quark return Glib.GQuark;  -- gst/gsterror.h:250
   pragma Import (C, gst_core_error_quark, "gst_core_error_quark");

   function gst_resource_error_quark return Glib.GQuark;  -- gst/gsterror.h:251
   pragma Import (C, gst_resource_error_quark, "gst_resource_error_quark");

   function gst_library_error_quark return Glib.GQuark;  -- gst/gsterror.h:252
   pragma Import (C, gst_library_error_quark, "gst_library_error_quark");

end GStreamer.GST_Low_Level.gstreamer_0_10_gst_gsterror_h;
