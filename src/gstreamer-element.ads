...
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gststructure_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstobject_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstbus_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstclock_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstpad_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstpadtemplate_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstcaps_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstevent_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstquery_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstmessage_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstiterator_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstformat_h;
private with GStreamer.GST_Low_Level.gstreamer_1_0_gst_gstsegment_h;
--  with GStreamer.GST_Low_Level.glib_2_0_glib_gquark_h;

package GStreamer.element is
   type GStelement is private;
